...
//namespace WinFormsChartSamples
{
	...
	public class RealTimeSample : System.Windows.Forms.UserControl
	{
        ...
        // true makes the thread start as "running", 
        // false makes it wait on _event.Set()
		...
		private void startTrending_Click(object sender, System.EventArgs e)
		{
            ...
            newSeries.Color = Color.FromArgb(Color.Orange.ToArgb());
        ...
        private void UpdateChart(float straight_line, List<DataPoint> curve)
        {
            ...
            var list = curve; 
            //curve.CopyTo(list);  // Clone the curve
		...
		private void InitializeComponent()
		{
            ...
            this.startTrending.Location = new System.Drawing.Point(117, 296);
            ...
            this.chart1.Size = new System.Drawing.Size(852, 328);
            ...
            this.stopTrending.Location = new System.Drawing.Point(195, 296);
            ...
            this.Size = new System.Drawing.Size(858, 331);
